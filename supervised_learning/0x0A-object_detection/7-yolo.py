...
class Yolo:
    ...
    def show_boxes(self, image, boxes, box_classes, box_scores, file_name):
        """
            ...
            Class names and box scores are drawn above each box in red
            Box scores are rounded to 2 decimal places
            Text is written 5 pixels above the top left corner of the box
            Text is written in FONT_HERSHEY_SIMPLEX
            Font scale is 0.5
            Line thickness is 1
            LINE_AA as the line type
            The window name is the same as file_name
            If the s key is pressed:
                The image is saved in the directory detections,
                    located in the current directory
                If detections does not exist, it is created
                The saved image has the file name file_name
    ...
    def predict(self, folder_path):
        ...
        All image windows are named after the corresponding image filename
