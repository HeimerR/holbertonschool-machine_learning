...
class Transformer(tf.keras.Model):
    ...
    def call(self, inputs, target, training, encoder_mask,
        ...
        """
        enc_output = self.encoder(inputs, training, encoder_mask)  # (batch_size, inp_seq_len, d_model)
        ...
        final_output = self.linear(dec_output)  # (batch_size, tar_seq_len, target_vocab_size)
